                            ...
                            <f:form class="cart-form" modelAttribute="cartVO" method="post" action="saveCart">
                                        ...
                                        <tr>
                                            <c:forEach items="${cartList}" var="cartVariable">
                                                <td class="product-remove">
                                                    <a href="javascript:void(0)"><i class="fa fa-times-circle"
                                                                                    aria-hidden="true"></i></a>
                                                </td>
                                                <td class="product-thumbnail">
                                                    <a>
                                                        <img src="<%=request.getContextPath()%>/product/${cartVariable.productVO.productFileName}"
                                                             alt=""/></a>
                                                </td>
                                                ...
                                                <td class="product-price">
                                                    <span class="product-price-amount amount"><span
                                                            class="currency-sign">Rs.</span>${cartVariable.poductVO.productPrice }</span>
                                                </td>
                                                <td>
                                                    <div class="product-quantity">
                                                        <span onclick="changeQuantity(${cartVariable.id},${cartVariable.productVO.productPrice },'+')"
                                                              data-value="+" class="quantity-btn quantityPlus"></span>
                                                        <input id="quant-${cartVariable.id}" class="quantity input-lg"
                                                ...
                                                <td class="product-subtotal">
                                                        <span class="product-price-sub_totle amount">
                                                            ...
                                                            <span id="cart-${cartVariable.id}">${cartVariable.poductVO.productPrice }</span>
                                                        </span>
                                                </td>
                                            </c:forEach>
                                                <%--                                                    <td class="product-remove">
                                                                                                    ...
                                                                                                    <td class="product-thumbnail">
                                                                                                        <a>
                                                                                                            <img src="<%=request.getContextPath()%>/product/Parle-G.jpg" alt="" /></a>
                                                                                                    </td>
                                                                                                    <td class="product-name">
                                                                                                        <a>Parle G</a>
                                                                                                    </td>
                                                                                                    <td class="product-price">
                                                                                                        <span class="product-price-amount amount"><span class="currency-sign">Rs.</span>20</span>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <div class="product-quantity">
                                                                                                            <span onclick="changeQuantity(1,20,'+')" data-value="+" class="quantity-btn quantityPlus"></span>
                                                                                                            <input id="quant-1" class="quantity input-lg" step="1" min="1" name="quantity" value="1" title="Quantity" />
                                                                                                            <span onclick="changeQuantity(1,20,'-')" data-value="-" class="quantity-btn quantityMinus"></span>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                    <td class="product-subtotal">
                                                                                                        <span class="product-price-sub_totle amount">
                                                                                                            <span class="currency-sign">Rs.</span>
                                                                                                            <span id="cart-1">20</span>
                                                                                                        </span>
                                                                                                    </td>--%>
                                        </tr>
                                        </tbody>
                                ...
                                <div class="row cart-actions">
                                    <div class="col-md-6 text-right">
                                        <input class="btn btn-md btn-gray" name="update_cart" value="Continue Shopping"
                                               type="submit">
                                    </div>
                                </div>
                            </f:form>
                            <div class="cart-collateral">
                                <div class="cart_totals">
                                    ...
                                    <div class="product-proceed-to-checkout">
                                        <a class="btn btn-lg btn-color form-full-width" href="checkout">Proceed to
                                            checkout</a>
                                    </div>
                                </div>
                            </div>
