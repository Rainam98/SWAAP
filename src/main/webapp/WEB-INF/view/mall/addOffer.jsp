				...
				<div class="col-12">
					<div class="box-content">
						...
						<div class="form-group">
								<label for="inp-type-1" class=" control-label">Offer Name</label>
								<input type="text" name="offnme" class="form-control" id="inp-type-1" placeholder="Enter Offer Name">
						</div>
						<!-- /.box-title -->
						...
						<div class="form-group">
								...
								<input type="text" name="dis" class="form-control" id="inp-type-1" placeholder="Enter Discount value">
						</div>
						<div class="form-group">
										<label for="inp-type-1" class=" control-label">Valid from</label>
											<div class="input-group">
												<input type="text" name="from" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
						...
						<div class="form-group">
										<label for="inp-type-1" class=" control-label">Valid till</label>
											<div class="input-group">
												<input type="text" name="till" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
												<span class="input-group-addon bg-primary text-white"><i class="fa fa-calendar"></i></span>
											</div>
											<!-- /.input-group -->
										</div>
