					...
					<div class="box-content">
						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<c:forEach items="${categoryList}" var="categoryVariable">
								<tr>
									<td>${categoryVariable.id}</td>
									<td>${categoryVariable.categoryName}</td>
									<td><a  href="deleteCategory?findById=${categoryVariable.id}"><i class="menu-icon fa fa-trash-alt" aria-hidden="true"></i></a></td>
									<td><a  href="updateCategory?findById=${categoryVariable.id}"><i class="menu-icon fa fa-edit" aria-hidden="true"></i></a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
