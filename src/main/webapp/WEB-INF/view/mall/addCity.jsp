		...
		<div class="row small-spacing">
			<div class="col-12">
				<div class="box-content">
					...
					<f:form data-toggle="validator" modelAttribute="cityVO" method="post" action="saveCity">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<f:hidden path="id"/>
							<label for="inputComplaintSubject" class="control-label">City</label>
							<f:input path="cityName" name="ctnme" class="form-control" id="inputName" placeholder="Enter City Name" required="true"/>
						</div>
						
						<div class="form-group">
							<button type="submit" name="addst" class="btn btn-primary waves-effect waves-light">Add City</button>
						</div>
					</f:form>
				</div>
				<!-- /.box-content -->
