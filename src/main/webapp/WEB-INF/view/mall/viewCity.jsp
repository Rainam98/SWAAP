						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<tbody>
								<c:forEach items="${cityList}" var="cityVariable">
									<tr>
										<td>${cityVariable.id}</td>
										<td>${cityVariable.stateVO.stateName}</td>
										<td>${cityVariable.cityName}</td>
										<td><a  href="deleteCity?findById=${cityVariable.id}"><i class="menu-icon fa fa-trash-alt" aria-hidden="true"></i></a></td>
										<td><a  href="updateCity?findById=${cityVariable.id}"><i class="menu-icon fa fa-edit" aria-hidden="true"></i></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
