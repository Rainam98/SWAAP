			...
			<div class="row small-spacing">
				<div class="col-12">
					<div class="box-content">
						<h4 class="box-title">View Sub-Category</h4>
						<!-- /.box-title -->
						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<tbody>
								<c:forEach items="${subCategoryList}" var="subCategoryVariable">
									<tr>
										<td>${subCategoryVariable.id}</td>
										<td>${subCategoryVariable.categoryVO.categoryName}</td>
										<td>${subCategoryVariable.subCategoryName}</td>
										<td><a  href="deleteSubCategory?findById=${subCategoryVariable.id}"><i class="menu-icon fa fa-trash-alt" aria-hidden="true"></i></a></td>
										<td><a  href="updateSubCategory?findById=${subCategoryVariable.id}"><i class="menu-icon fa fa-edit" aria-hidden="true"></i></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
