					...
					<div class="box-content">
						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<c:forEach items="${stateList}" var="stateVariable">
								<tr>
									<td>${stateVariable.id}</td>
									<td>${stateVariable.stateName}</td>
									<td><a  href="deleteState?findById=${stateVariable.id}"><i class="menu-icon fa fa-trash-alt" aria-hidden="true"></i></a></td>
									<td><a  href="updateState?findById=${stateVariable.id}"><i class="menu-icon fa fa-edit" aria-hidden="true"></i></a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
