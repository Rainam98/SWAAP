						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<tbody>
								<tr>
									...
									<td>fddjdduhbdjd</td>
									<td><a  href="deleteCity"><i class="menu-icon fa fa-trash-alt" aria-hidden="true"></i></a></td>
									<td><a  href="updateCity"><i class="menu-icon fa fa-edit" aria-hidden="true"></i></a></td>
								</tr>
							</tbody>
						</table>
					</div>
